 ...
 * @author brand
 */
public class Edit_video extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_edit_finish_video = new javax.swing.JButton();
        ...
        btn_edit_finish_video.setBackground(new java.awt.Color(63, 225, 176));
        btn_edit_finish_video.setFont(new java.awt.Font("Franklin Gothic Demi", 0, 24)); // NOI18N
        btn_edit_finish_video.setForeground(new java.awt.Color(255, 255, 255));
        btn_edit_finish_video.setText("Editar");
        btn_edit_finish_video.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_edit_finish_videobtn_create_acc(evt);
            }
        });
        jPanel1.add(btn_edit_finish_video, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 510, 230, 60));
        ...
        jPanel1.add(btn_upload_image_video, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 450, 151, 35));
        ...
        jPanel1.add(label_description, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, 80, 20));

        label_imagen.setFont(new java.awt.Font("Franklin Gothic Demi", 0, 14)); // NOI18N
        label_imagen.setForeground(new java.awt.Color(203, 203, 203));
        label_imagen.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label_imagen.setText("Imagen");
        jPanel1.add(label_imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 430, 150, 20));
    ...
    private void btn_edit_finish_videobtn_create_acc(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_edit_finish_videobtn_create_acc
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_edit_finish_videobtn_create_acc
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_video.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_video().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btn_edit_finish_video;
